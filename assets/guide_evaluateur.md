...
- Recueillir les données significatives auxquelles on devra faire appel pour introduire les échanges ou pour argumenter si nécessaire (les événements marquants de l'année écoulée, positifs ou négatifs).
...
**Clarté** — Être clair dans ce qu'on va dire, surtout s'il s'agit d'un point nécessitant une amélioration :
- Être objectif, c'est-à-dire s'appuyer sur des faits. Ces faits devront :
  - être suffisamment répétitifs pour représenter une attitude,
  - être précis et bien repérés (exemples),
  - avoir fait l'objet d'une discussion lorsqu'ils sont survenus.
- Prendre du recul pour analyser les faits et pouvoir traduire ce qu'ils signifient ;
...
- Se fonder sur des impressions.
- Se fonder sur un seul événement, ou le dernier parce qu'on l'a encore en mémoire.
- S'en tenir à un constat du travail de l'agent sans avoir comme préoccupation de l'aider à développer ses compétences. **Le passé n'a d'autre valeur que celle de montrer sur quoi agir dans l'avenir.**
...
C'est un document partagé entre le responsable hiérarchique et son collaborateur, qui permet d'identifier des écarts éventuels entre les activités et compétences attendues et réelles, et d'assurer la progression et le développement des compétences des agents.
...
Il est préférable de décrire une activité en commençant par un **verbe substantif** puis en continuant par l'objet de l'activité, afin d'identifier le niveau de contribution. Des éléments quantitatifs peuvent être apportés.
...
- L'agent a été récemment recruté (un à deux ans) et n'assure pas encore toutes les activités attendues.
- Les contraintes organisationnelles ont pu nécessiter de différer la mise en œuvre de certaines activités.
- Un déficit de formation, de compétences, d'accompagnement, de moyens ou d'organisation peut freiner la capacité de l'agent à développer telle activité.
...
**Exemples de savoirs :**
- Statut de la FPT
- Organisation des institutions calédoniennes
...
- Savoir orienter l'interlocuteur vers la bonne personne
- Savoir rédiger un cahier des charges
- Savoir créer et alimenter un planning de suivi de l'activité
- Savoir analyser un tableau de bord
- Savoir conduire un projet opérationnel
- Savoir élaborer un budget
- Savoir concevoir et tester des outils d'évaluation
...
- Fixation concertée du plan de l'entretien :
  - expression de chacun,
  - écoute et recherche mutuelle de compréhension,
  - synthèse écrite sur les documents (résultat d'un consensus entre l'agent et l'évaluateur).
- Solliciter l'adhésion sur le plan de l'entretien.

**Pendant l'entretien**

Les étapes clés :

1. Se cadrer par rapport au poste et à ses exigences.
2. S'appuyer sur l'autoévaluation réalisée par l'agent pour :
   - analyser les résultats obtenus au regard des missions permanentes et des objectifs fixés (laisser l'évalué s'exprimer en premier sur le bilan de l'année écoulée) ;
   - retrouver les faits marquants de l'année précédente et en faire le bilan ;
   - traiter les désaccords éventuels.
3. Établir un plan d'action pour l'année, sur la base d'objectifs professionnels et d'objectifs de progrès individuels.
4. Définir les moyens correspondants.
5. Recueillir les souhaits d'évolution personnelle du collaborateur.
6. Aborder la question de la notation.
7. Donner un avis sur l'avancement d'échelon ou de classe, le cas échéant.

**Quelques conseils**
- Communiquer des informations que l'on n'a pas l'habitude de donner au quotidien et qui permettent aux agents de se situer (données budgétaires, priorités politiques…).
- Ne pas oublier de valoriser les faits positifs : ce qu'ils ont apporté au service, ce qu'ils signifient pour l'avenir.
...
- **Une mauvaise communication** : manque d'écoute, manque de clarté, mélanger expression des points de vue et discussion, susciter des réactions sans avoir la volonté d'en tempérer les conséquences.
- **Le paternalisme, la démagogie, donner l'impression de juger une personne.** En réalité, un agent n'est pas automatiquement bon ou mauvais : ses capacités correspondent ou pas aux exigences du poste. Les compétences manquantes peuvent être acquises, et un agent peut ne pas correspondre à tel poste mais parfaitement correspondre à tel autre.
- **Traiter ou rejeter des questions hors sujet.** Les agents vont apporter des points de discussion qui n'ont pas à être traités lors de l'entretien. Il importe de les prendre en compte en indiquant clairement quand, où et qui traitera le problème — sans les traiter sur le moment (dérive), ni les rejeter (démotivation).
...
- **La tenue du poste** — Précise les écarts observés entre les activités attendues de la fiche de poste et celles réalisées effectivement. Ces écarts sont analysés pour donner lieu, le cas échéant, à l'ajustement de la fiche de poste ou à des actions correctrices (formation, moyens supplémentaires…).

- **Le rappel des objectifs et les résultats obtenus** — Les objectifs fixés l'année précédente sont rappelés. L'évaluateur identifie et analyse les résultats obtenus de façon mesurable, concrète et factuelle. La rubrique « commentaires » permet à l'agent de spécifier les éléments du contexte ayant favorisé ou freiné l'atteinte des objectifs.

- **L'appréciation des compétences mises en œuvre** — Permet de repérer les points de progrès de l'agent.

- **La contribution aux objectifs collectifs** — Les résultats sont analysés au regard de la contribution de l'agent à l'atteinte des objectifs collectifs de l'équipe.
...
> Un organigramme permettant de situer le poste du collaborateur est **obligatoirement joint** au dossier. Il est souhaitable que le dossier de l'entretien soit **dactylographié** afin de faciliter sa consultation.
...
| Évalué | Évaluateur |
|--------|-----------|
| **Qu'est-ce que j'ai fait ?** | **Qu'a fait mon collaborateur ?** |
| — j'ai aimé le faire… pourquoi ? | — Quels étaient mes critères et mes exigences ? |
| — je n'ai pas aimé le faire… pourquoi ? | — Quels étaient les résultats attendus ? |
| — je l'ai fait facilement… pourquoi ? | — Qu'a-t-il fait facilement ? |
| — je ne l'ai pas fait facilement… pourquoi ? | — Sur quoi a-t-il rencontré des difficultés ? |
| **Qu'est-ce que je n'ai pas fait ?** | — Que n'a-t-il pas fait et qu'il aurait dû faire ? Pourquoi ? |
| — j'aurais dû faire… pourquoi ? | |
...
| Évalué | Évaluateur |
|--------|-----------|
| — Qu'est-ce que j'envisage d'améliorer dans la tenue de mon poste l'année prochaine et pourquoi ? | — Quels étaient les objectifs du service ? |
| — Qu'est-ce que je propose de nouveau pour le service l'année prochaine et pourquoi ? | — Quels étaient les objectifs propres à l'évalué ? |
...
| Évalué | Évaluateur |
|--------|-----------|
| — d'une définition plus précise de mon poste ? | — Sur quoi son poste aurait-il besoin d'être mieux défini ? |
| — d'une formation ? | — En quoi une formation lui serait-elle utile ? |
| — d'une réorganisation de mes activités ? | — En quoi une réorganisation de ses activités serait-elle utile ? |
| — d'une nouvelle définition de mes priorités ? | — Quelles seraient pour lui les priorités de l'année à venir ? |
...
| Évalué | Évaluateur |
|--------|-----------|
| — Quelle est la formation que je souhaite suivre ? Pourquoi ? | — Quelles nouvelles attributions puis-je lui confier dans le service ? |
| — Quel est le concours ou examen que je souhaite passer ? Pourquoi ? | — Quelles perspectives d'évolution peut-il avoir au sein de la collectivité ? |
| — Ai-je envie de changer de service ? Si oui, pourquoi et pour quel service ? | — À quelle promotion peut-il prétendre ? |
| — Ai-je envie de changer de poste ? Si oui, pourquoi et pour quel poste ? | |
| — Quel est mon projet professionnel à long terme ? | |
